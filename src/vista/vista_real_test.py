                       ...
                       ft.Column(
                        ...
                        ft.Container(
                            ...
                            content=ft.Column(
                                expand=True,
                                controls=[
                                    ft.Text("Seleccionar estudiante:", size=20, weight=ft.FontWeight.BOLD, color="black", selectable=True),
                        ...
                        ft.Container(
                            ...
                            content=ft.Column(
                                expand=True,
                                controls=[
                                    ft.Text("Terminar test incompleto:", size=20, weight=ft.FontWeight.BOLD, color="black", selectable=True),
